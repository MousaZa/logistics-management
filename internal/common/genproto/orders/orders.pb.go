...
func (x *NewStatus) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
const file_orders_proto_rawDesc = "" +
	"\n" +
	"\forders.proto\x12\x06orders\x1a\x1bgoogle/protobuf/empty.proto\"#\n" +
	"\tNewStatus\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status2L\n" +
	"\rOrdersService\x12;\n" +
	"\fUpdateStatus\x12\x11.orders.NewStatus\x1a\x16.google.protobuf.Empty\"\x00B9Z7github.com/MousaZa/logistics-management/internal/ordersb\x06proto3"
...
var file_orders_proto_goTypes = []any{
	(*NewStatus)(nil),     // 0: orders.NewStatus
	(*emptypb.Empty)(nil), // 1: google.protobuf.Empty
}
var file_orders_proto_depIdxs = []int32{
	0, // 0: orders.OrdersService.UpdateStatus:input_type -> orders.NewStatus
	1, // 1: orders.OrdersService.UpdateStatus:output_type -> google.protobuf.Empty
