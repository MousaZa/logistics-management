...
type ServerInterface interface {
	...
	GetOrderById(w http.ResponseWriter, r *http.Request, orderUUID openapi_types.UUID)
...
// (GET /orders/{orderUUID})
func (_ Unimplemented) GetOrderById(w http.ResponseWriter, r *http.Request, orderUUID openapi_types.UUID) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) GetOrderById(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "orderUUID", chi.URLParam(r, "orderUUID"), &orderUUID, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetOrderById(w, r, orderUUID)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/orders/{orderUUID}", wrapper.GetOrderById)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/orders/{orderUUID}/cancel", wrapper.CancelOrder)
	})
